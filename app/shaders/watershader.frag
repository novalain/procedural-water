...
void main() {
  ...
  // vec3 reflectionSample = vec3(texture2D(reflectionTexture, reflectionCoords + noise));

  // gl_FragColor = vec4(waterColor * (reflectionSample+vec3(0.1)) * (diffuse + specular + 0.2) * 3.0, 1.0);
